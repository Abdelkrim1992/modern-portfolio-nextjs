...
export const gridItems = [
  {
    id: 1,
    title: "I bring creative problem-solving to every project challenge",
    description: "",
  ...
  {
    id: 2,
    title: "I'm highly adaptable to different time zone requirements",
    description: "",
  ...
  {
    id: 4,
    title: "Passionate problem-solver dedicated to clean, efficient code",
    description: "",
...
export const projects = [
  ...
  {
    id: 3,
    title: "Luxury Car Rental Booking Platform",
